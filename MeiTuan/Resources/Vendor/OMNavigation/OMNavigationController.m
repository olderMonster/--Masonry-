...
- (void)viewDidLoad {
    ...
    //设置属性
    NSDictionary *barAttributes = [NSDictionary dictionaryWithObjectsAndKeys:[UIColor blackColor],NSForegroundColorAttributeName,[NSValue valueWithUIOffset:UIOffsetZero],NSShadowAttributeName,[UIFont systemFontOfSize:20],NSFontAttributeName, nil];
